...
$getQuestion=$connect->query("SELECT *FROM questions JOIN students ON questions.Student_id=students.Student_id where questions.question_status='aproved'");
?>
            ...
            <div class="box-body" style="overflow-x: scroll;">  
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php while($r=$getQuestion->fetch_object()){
                $getAnswer=$connect->query("select *from answer where Question_id=$r->Question_id");
                $count=$getAnswer->num_rows;
                ?>
               <tr>
