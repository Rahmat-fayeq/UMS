...
$getArticles=$connect->query("SELECT *FROM articles JOIN teachers ON articles.Teacher_id=teachers.Teacher_id where articles.Article_status='aproved'");
?>
                ...
                <tbody>
                  <?php while($r=$getArticles->fetch_object()){?>
                      <tr>
                        ...
                        <td><a href="../web/artilce_details.php?aid=<?php echo $r->Article_id?>"><button class="btn btn-info">View</button></a></td>
